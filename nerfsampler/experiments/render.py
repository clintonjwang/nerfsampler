...
def render_with_procedural_texture(nerfacto, camera_ray_bundle, coords, n_frames=64):
...
def render_with_texture_map(nerfacto, camera_ray_bundle, coords, texture_map, n_frames=64):
...
def render_with_seg_recolored(nerfacto, camera_ray_bundle, recolored_coords, n_frames=64):
...
def render_with_seg_removed(nerfacto, camera_ray_bundle, coords, n_frames=64):
...
def render_with_seg_duplicated(nerfacto, camera_ray_bundle, orig_coords, n_frames=64):
    theta = .5
...
def render_reflective_material(nerfacto, camera_ray_bundle, coords, n_frames=64):
    for ix in range(len(nerfacto.density_fns)):
...
def render_with_affine_tx(nerfacto, camera_ray_bundle, orig_coords, n_frames=64):
    for ix in range(len(nerfacto.density_fns)):
