...
def create_sweep(name, method="random", target='val_loss', parameter_dict=None):
    ...
    sweep_id = wandb.sweep(sweep_config, project='nerfsampler')
...
def sweep_discretization_type():
    ...
    return wandb.sweep(sweep_config, project='nerfsampler')
