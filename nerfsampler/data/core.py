...
def get_dataset(mode, cfg, max_len=None, full_scale=False):
    ...
    # Create dataset
    if dataset_type == 'nmr':
        dataset_folder = osp.expandvars(f'$DS_DIR/DVR/NMR_Dataset')
        ...
        dataset_folder = osp.expandvars(f'$DS_DIR/kubric-public/tfds/{dataset_type}')
